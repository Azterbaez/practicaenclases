...
const obtenernombresproducto =productoss.map(pro => pro.nombre);
console.log(obtenernombresproducto);

const preciototalinventario =  productoss.reduce((acc, pro) => acc + (pro.precio * pro.stock), 0);
console.log(preciototalinventario);  

const categoriaMuebles = productoss.filter(pro => pro.categoria === "Muebles");
console.log(categoriaMuebles);

// 3. 3. Crea una función flecha que reciba el arreglo y devuelva el primer producto cuyo precio sea mayor a 1000.
const preciomayor1000 = productoss.find(productos => productos.precio > 1000);
...
const todosconstock = productoss.every(pro => pro.stock > 0);
...
const pertenececateElectrodomesticos = productoss.some(pro => pro.categoria === "Electrodomésticos");
console.log(pertenececateElectrodomesticos);
...
const ordenadopreciomenoramayor = [...productoss].sort((a, b) => a.precio - b.precio);
console.log(ordenadopreciomenoramayor);